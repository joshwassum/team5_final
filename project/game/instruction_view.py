...
class InstructionView(arcade.View):
    ...
    def on_draw(self):
        ...
        arcade.draw_text("Controls: : Jump/Climb up'w' or up arrow key, Climb down: 's' or down arrow key, Right: 'd' or right arrow key, Left: 'a' or left arrow key.", self.window.width / 2, self.window.height / 2-100,
                        arcade.color.WHITE, font_size=12, anchor_x="center")
